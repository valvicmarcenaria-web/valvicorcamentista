...
GARANTIA — corrigida pelo Jonathan [07/08], substitui a tabela de
`proposta-comercial.md` (que trazia 10 anos / 2 nas corrediças):
  Telescópica ..... 2 anos, GERAL
  Oculta Hardt .... 5 anos
São 3 anos de diferença — a garantia mais que dobra. E, sem detalhar: o
Jonathan pediu o número, não a abertura por componente.
...
<div class="page"><div class="pad">
  ...
  <div class="h-sec serif" style="font-size:25pt;">Uma peça muda.<br><em>A garantia mais que dobra.</em></div>
  <hr class="rule" style="margin:8px 0;">
  <p class="lead" style="margin-bottom:2mm;">São <b>14 gavetas</b> nesta cozinha. A corrediça
  que corre debaixo delas é a única coisa que separa as duas versões — e é ela que define a
  garantia do conjunto.</p>

  <div class="lin">
    <div>
      <div class="k">Versão 1 · corrediça telescópica</div>
      <div class="t">R$ {br(T_TOT)}</div>
      <div class="g2">2 anos<br>de garantia</div>
      ...
      fica <b>visível na lateral</b> quando ela está aberta.</div>
    </div>
    <div class="g">
      <div class="k">Versão 2 · corrediça oculta Hardt</div>
      <div class="t">R$ {br(O_TOT)}</div>
      <div class="g2">5 anos<br>de garantia</div>
  ...
  <div class="pull" style="margin-top:6mm;">
    ...
    investimento, ou <b>R$ 100 por gaveta</b>. É o que custa levar a garantia de <b>2 para 5
    anos</b>, na peça que mais abre e fecha na casa inteira.</div>
  </div>
...
<div class="page"><div class="pad">
  ...
  <div class="cnd">
    <div><div class="k">Garantia</div>
      <div class="v"><b>2 anos</b> na versão telescópica · <b>5 anos</b> na versão oculta Hardt.</div></div>
