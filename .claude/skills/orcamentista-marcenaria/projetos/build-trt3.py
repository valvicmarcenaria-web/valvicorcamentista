...
<div class="page cover">
  ...
  <div class="inner">
    ...
    <div class="strip">
      ...
      <div class="c"><div class="k">Ferragens</div><div class="v">Hettich · Blum</div></div>
    </div>
  </div>
</div>
...
<div class="page"><div class="pad">
  ...
  <div class="split2" style="margin-top:5mm;">
    <div class="pull" style="background:var(--deep);border-left-color:var(--gold-lt);">
      ...
      <div class="d" style="color:#C6BFB2;">Alemã, fundada em 1888. Cada dobradiça é testada para
      <b style="color:#F0E7D6;">80 mil ciclos</b>: abrir e fechar a porta 10 vezes por dia durante
      20 anos. Num espaço de uso coletivo, é o que separa a porta que continua macia da que começa
      a bater.<br><br>
      <b style="color:#F0E7D6;">Hettich</b> (Alemanha) nas dobradiças e corrediças ·
      <b style="color:#F0E7D6;">Blum TIP-ON</b> (Áustria) no fecho-toque.</div>
    </div>
