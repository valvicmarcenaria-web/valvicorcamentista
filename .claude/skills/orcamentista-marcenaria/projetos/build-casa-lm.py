...
<div class="page"><div class="pad">
  ...
  <div class="inv-hero">
    ...
    <div class="v serif">R$ 180.600</div>
    ...
    <div class="alt">Ou <b>R$ 200.700</b> em <b>50% na assinatura + 50% na entrega</b>.
  ...
  <table class="item-tb">
    ...
    <tbody>
      <tr><td class="nm">Suíte — closet, roupeiro e sapateira<small>Carvalho Brun · 8 portas em vidro reflecta · 20 gavetas com corrediça oculta</small></td><td class="r">R$ 113.300</td></tr>
      ...
      <tr class="tot"><td>Total · à vista</td><td class="r">R$ 180.600</td></tr>
    </tbody>
  </table>
