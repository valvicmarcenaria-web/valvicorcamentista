...
<div class="page">
  ...
  <div class="note">
    ...
    Painéis em MDF Arauco Realce Cravo Trend (aparente) e Moscada Matt (caixas/móveis); pérgola em metalon #10×5 revestido em MDF madeirado; rodapé em perfil de inox escovado h=5 (serralheria) incluso. <b>Não inclusos:</b> forro em gypsum (gesseiro), <b>porta veneziana e vidro temperado do pilar (por conta de terceiros)</b>, pontos elétricos/hidráulicos de alimentação e serviços de obra civil (gesso, pintura, alvenaria). Medidas a conferir no local, conforme nota do projeto. Prazo a partir da aprovação do executivo e liberação da frente de trabalho.
  </div>
