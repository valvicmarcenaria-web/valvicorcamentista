# -*- coding: utf-8 -*-
# Proposta LM / SPE Nova Lima 1 (comercial) — config única. Layout leve/editorial (base Graça).
import pathlib
...
.cover .meta .v{font-family:'Cormorant Garamond','Georgia',serif;font-size:13pt;font-weight:700;color:var(--ink);}
...
<div class="page cover">
  ...
  <div class="inner">
    ...
    <div class="proj">Painéis, pérgola e mobiliário — stand de vendas · projeto arq. Lodi Motta</div>
    <div class="meta">
      <div class="m"><div class="t">Escopo</div><div class="v">Corretores · Pilar · Gourmet/Lounge</div></div>
      <div class="m"><div class="t">Acabamento</div><div class="v">MDF Arauco Realce Cravo Trend</div></div>
    </div>
    <div class="foot">
      <div><span class="sparkles">&#10022; &#10022; &#10022;</span><br>Do executivo ao encaixe, medido no milímetro.</div>
      <div style="text-align:right">17 de julho de 2026<br>validade 15 dias</div>
    </div>
  </div>
</div>
...
<div class="page">
  ...
  <div class="section-h serif">Escopo da marcenaria</div>
  <hr class="rule">
  <p class="lead">Leitura fiel do seu executivo — cada painel medido parede a parede e o metalon da pérgola calculado ripa a ripa. Nada estimado.</p>
...
<div class="page">
  ...
  <div class="hero">
    ...
    <div class="big serif">R$ 88.200</div>
    <div class="cap">Painéis + pérgola + mobiliário, fornecimento e instalação por equipe própria Valvic.</div>
  </div>

  <table>
    <thead><tr><th>Frente</th><th class="r">Valor</th></tr></thead>
    <tbody>
      <tr><td class="nmc">Painéis — MDF Cravo Trend (Gourmet/Lounge + Corretores + Pilar)</td><td class="r">R$ 45.700</td></tr>
      <tr><td class="nmc">Pérgola — 28 ripas metalon #10×5 revestido em MDF madeirado</td><td class="r">R$ 18.000</td></tr>
      <tr><td class="nmc">Portas — de giro (copa + armário) e acesso ao QG</td><td class="r">R$ 5.500</td></tr>
      <tr><td class="nmc">Móveis + complementos — armário gourmet, móvel lounge, sanca, inox</td><td class="r">R$ 19.000</td></tr>
    </tbody>
    <tfoot><tr class="grand"><td class="serif">Total</td><td class="r serif">R$ 88.200</td></tr></tfoot>
  </table>
  ...
  <div class="split">
    ...
    <div>
      ...
      <div class="hrule"></div>
      <div class="terms">
        <div class="term"><div class="t">Entrega</div><div class="b">45 a 60<br>dias úteis</div></div>
  ...
  <div class="note">
    ...
    Painéis em MDF Arauco Realce Cravo Trend (aparente) e Moscada Matt (caixas/móveis); pérgola em metalon #10×5 revestido em MDF madeirado; rodapé em perfil de <b>inox escovado 5×0,5 (h=5 cm)</b> — item de serralheria, fornecido por parceiro e coordenado/instalado pela Valvic (incluso). <b>Não inclusos:</b> forro em gypsum (gesseiro), <b>porta veneziana e vidro temperado do pilar (por conta de terceiros)</b>, pontos elétricos/hidráulicos de alimentação e serviços de obra civil (gesso, pintura, alvenaria). Medidas a conferir no local, conforme nota do projeto. Prazo a partir da aprovação do executivo e liberação da frente de trabalho.
  </div>

  <div class="pfoot"><span class="brandline">valvic<span class="dot">.</span> marcenaria</span><span>SPE Nova Lima 1 · Projeto Lodi Motta · 17/07/2026</span></div>
</div>

</body></html>"""
(P/'proposta-lm.html').write_text(HTML, encoding='utf-8')
print('wrote proposta-lm.html', len(HTML))
