...
<style>
  ...
  /* ambientes */
  .amb2{{border-top:1px solid var(--hair); padding:4.2mm 0;}}
  ...
  /* investimento */
  .inv{{background:var(--deep); border-radius:7px; padding:9mm 8mm; margin-top:4mm;
  ...
  .inv .k{{font-size:6.8pt; letter-spacing:.2em; text-transform:uppercase; color:var(--gold-lt);
      font-weight:700;}}
  .inv .big{{font-family:'Cormorant Garamond',Georgia,serif; font-size:42pt; font-weight:700;
      color:#fff; line-height:1.02; margin-top:2.2mm;}}
  .inv .sub{{font-size:9pt; color:#C6BFB2; margin-top:2.6mm; line-height:1.6;}}
  .inv .sub b{{color:var(--gold-lt);}}
  .pay2{{display:flex; margin-top:4mm; padding-top:3mm;
  ...
  .pay2 b{{display:block; font-family:'Cormorant Garamond',Georgia,serif; font-size:23pt;
      font-weight:700; color:var(--gold-lt); line-height:1;}}
  .pay2 span{{display:block; font-size:8.4pt; color:#C6BFB2; margin-top:1.6mm; line-height:1.55;}}

  .cond{{display:grid; grid-template-columns:1fr 1fr; gap:4.5mm 7mm; margin-top:6.5mm;
  ...
  .cond .k{{font-size:6.8pt; letter-spacing:.16em; text-transform:uppercase; color:var(--gold);
      font-weight:700;}}
  .cond .d{{font-size:9pt; color:var(--soft); line-height:1.6; margin-top:1mm;}}
...
<div class="page"><div class="pad">
  ...
  <div class="det">
    <div><div class="k">Bancadas</div><div class="t">Borda arredondada</div>
      <div class="d">Sem chanfro. O raio é usinado na própria peça — <b>quina que não
      machuca</b> e não lasca com o uso diário.</div></div>
...
<div class="page"><div class="pad">
  ...
  <table class="spec-tb" style="margin-top:3mm;">
    ...
    <tbody>
      <tr><td>Revestimento</td><td><b>MDF melamínico fosco</b> em todo o conjunto —
        <b>sem a linha acetinato e sem a linha Aris</b>, conforme definido. Cor única
        nos cinco ambientes.</td></tr>
      <tr><td>Bancadas</td><td><b>Borda arredondada</b>, com o raio usinado na peça —
        <b>sem acabamento chanfrado</b>. É o detalhe que define o toque do móvel e o que
        mais aparece num espaço de atendimento.</td></tr>
      ...
      <tr><td>Ferragens</td><td><b>Hettich</b>, com amortecimento nas portas dos armários
        da copa e <b>garantia vitalícia da ferragem</b> pelo fabricante.</td></tr>
  ...
  <div class="warr">
    ...
    porque a equipe é <b>própria do corte à instalação</b> — inclusive a serralheria dos
    pés, que sai coordenada com a marcenaria e não como um fornecedor à parte.</div>
  </div>
...
<div class="page"><div class="pad">
  ...
  <div class="cond">
    ...
    <div><div class="k">Garantia</div><div class="d"><b>10 anos</b> em contrato ·
      <b>2 anos</b> de instalação e regulagem.</div></div>
  ...
  <div class="obs">
    <b>Incluso:</b> revestimento das bancadas de pedra existentes · bancadas novas e
    acopladas · bancadas suspensas · armários inferior e superior da copa · torre de
    apoio com os nichos de frigobar, cafeteira e micro-ondas · pés em serralheria com
    pintura eletrostática · ferragens · entrega e instalação.<br>
    <b>Não incluso:</b> as pedras das bancadas existentes (mantidas) · eletrodomésticos ·
    pontos elétricos e hidráulicos novos · pintura, gesso e forro do espaço.<br>
    <b>Medição:</b> conferida no local antes do corte. Qualquer divergência entre a
    medida real e a premissa desta proposta é reapresentada antes de qualquer produção.
  </div>

  <div class="det" style="margin-top:7mm;">
